...
def main():
    ...
    if args.print_policy is not None:
        ...
        try:
            ...
            print()
            print("# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            print("# TWO OPTIONS TO CREATE IAM-SORRY MANAGER USER")
            print("# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            print()
            print("# OPTION 1 (AUTOMATED): If you have IAM admin access")
            print("# ─────────────────────────────────────────────────────────────────────")
            print(
                f"#   $ iam-sorry --profile <iam-admin> --create-iam-sorry {user_prefix}-iam-sorry"
            )
            print("#")
            print("#   This will automatically:")
            print(f"#   • Create IAM user '{user_prefix}-iam-sorry'")
